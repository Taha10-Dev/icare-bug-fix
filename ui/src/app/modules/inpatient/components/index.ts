...
import { InpatientServicesComponent } from "./inpatient-services/inpatient-services.component";
...
export const inpatientComponents = [AssignBedToPatientComponent, WardsListComponent, InpatientComponent, InpatientServicesComponent];
